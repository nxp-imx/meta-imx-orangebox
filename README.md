i.MX Linux Yocto Project BSP 6.18.2-1.0.0 OrangeBox
=============================================================
...
```
$ repo init -u https://github.com/nxp-imx/imx-manifest -b imx-linux-whinlatter -m imx-6.18.2-1.0.0_orangebox.xml
```

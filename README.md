i.MX Linux Yocto Project BSP 6.6.52-2.2.0 OrangeBox
=============================================================
...
```
$ repo init -u https://github.com/nxp-imx/imx-manifest -b imx-linux-scarthgap -m imx-6.6.52-2.2.0_orangebox.xml
```
